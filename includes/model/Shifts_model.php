...
function removeShift($shift_id) {
  mail_shift_delete(findShift($shift_id));
...
function Shift_update($shift) {
  ...
  mail_shift_change(findShift($shift['SID']), $shift);
...
/**
 * Finds a Shift with its room and shift type by the shift id.
 *
 * @param $shiftId
 * @return Result|array
 */
